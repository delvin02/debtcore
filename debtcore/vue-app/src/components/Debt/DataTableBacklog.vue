...
import { ref, inject, reactive, onMounted, nextTick, watch, type Ref } from 'vue'
...
async function init() {
	try {
		...
		let errorMessage = 'Form initialisation error.'
		toast({
...
watch([headerElement, footerElement], updateHeight, { immediate: true })
