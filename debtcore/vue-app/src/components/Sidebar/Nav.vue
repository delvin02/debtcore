...
<template>
	<div
		...
		class="hidden group md:flex flex-col gap-4 py-2 data-[collapsed=true]:py-2"
	>
		<nav
			class="grid gap-1 px-2 roup-[[data-collapsed=true]]:justify-center group-[[data-collapsed=true]]:px-2"
		>
