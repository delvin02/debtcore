...
const usageReport = '/api/template'
...
onMounted(async () => {
	await tableStore.fetch(usageReport, 0, map_function) // Pass the URL when calling the action
})
...
<template>
	<div class="p-4 md:p-8 space-y-8">
		<div class="flex items-center justify-between space-y-2">
			<div>
				<h2 class="text-2xl font-bold tracking-tight">Usage Report</h2>
				<p class="text-muted-foreground">Here&apos;s a list of your existing reports!</p>
			</div>
		</div>
